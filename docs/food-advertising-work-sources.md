...
Reviewed the captions in `archive/deliverables/whimsy_context_catalog/inventory.csv` and visually inspected the original media. The four images are copied unchanged into `public/work/archive/` and each appears once on the page.

- **January 22, 2024, Media Monday:** `769506615203625.jpg`. The caption describes Whimsy's recent ad creation for different brands. The Buffalo Wild Wings artwork features chicken wings, brand colors, and an order prompt.
- **March 1, 2024, graphic-design portfolio post:** `793715222782764.jpg`. The post presents examples of Whimsy's design work. The Burnt Honey advertisement combines a food photograph, yellow and black graphics, its identity, and Spring Arbor location details.
- **June 29, 2024, design-work showcase:** `870210031799949.jpg` and `870210345133251.jpg`. The caption discusses work with businesses and offers logo rework, ads, and posters. Craveable's piece promotes plant-based food with a location cue. Shorties' event advertisement includes its chef, food truck, June 30 date, noon start, and event location.
