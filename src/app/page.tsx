...
export default function Home() {
  return <main>
    <section className="home-hero shell">
      <div className="home-copy"><Image className="home-logo" src="/logo%20tight.png" alt="Whimsy Consulting, Media, Marketing" width={4744} height={2198} priority/><h1 className="home-tagline">Local strategy. Creative media. Practical growth.</h1><p>Whimsy helps local businesses and organizations strengthen their brand, promote events, improve their online presence, and make practical decisions about growth. We combine consulting, media, marketing, and website support with firsthand knowledge of the Jackson-area community.</p><div className="actions"><Link className="button" href="/work">✦ Explore our work</Link><Link className="button outline" href="/contact">▣ Book a consultation</Link></div></div>
