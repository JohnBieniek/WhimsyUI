...
export function WebsiteTransferCosts() {
  return <section className="transfer-costs" aria-labelledby="transfer-costs-title">
    ...
    <div className="transfer-cost-highlight"><strong><span className="transfer-editor-desktop">$0 / month for your content editor</span><span className="transfer-editor-mobile">$0 / month for your editor</span></strong><p>The standard website transfer is a one-time $750 service. Pages CMS access and your own content edits have no subscription fee.</p></div>
    ...
    <div className="transfer-cost-details">
      <article><h3>What could you save?</h3><p>Replacing a $17-a-month website plan removes $204 a year in subscription charges. With these savings, the transfer more than pays for itself over time. Higher monthly bills can mean a quicker payback.</p></article>
      <article className="transfer-remaining-costs"><h3>What might you still pay for?</h3><p>Your domain name still needs renewing. However, that cost will be the same or lower than if you stay with your old provider. We confirm hosting costs and any paid email, booking, shop, or other tools before the move; free hosting can suit a straightforward business website. Optional work you ask us to do is separate. We help you check what can be canceled after launch so you keep the services you still use.</p></article>
    </div>
  </section>;
}
