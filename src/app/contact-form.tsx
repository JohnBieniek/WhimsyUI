...
export default function ContactForm() {
  ...
  return <form className="contact-form" onSubmit={submit}>
    ...
    <div className="form-row"><label>Email *<input required type="email" name="email" autoComplete="email" placeholder="you@example.com"/></label><label>Phone <small>(optional)</small><input name="phone" autoComplete="tel" placeholder="(517) 555-0123"/></label></div>
