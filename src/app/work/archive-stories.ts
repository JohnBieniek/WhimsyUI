...
type StorySection = { kicker: string; title: StoryHeading; paragraphs: string[]; images: [string, string][]; galleryLayout?: "stacked" | "centered" | "paired" | "aligned"; layout?: "image-left"; card?: "light-purple" | "light-mint"; accent?: "activities" | "shopping" | "event" | "value" };
