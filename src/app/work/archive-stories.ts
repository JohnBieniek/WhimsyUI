...
export const archiveStories: Record<string, ArchiveStory> = {
  ...
  "fetch-market-launch": {
    summary: "Consulting and media marketing for Fetch Market & Deli, introducing Chef Gretchen's plans for a new food and market destination in downtown Brooklyn.",
    heading: "Help a new business become familiar before it opens.",
    introduction: ["Fetch Market & Deli began sharing its plans for a downtown Brooklyn corner location before the doors opened. Whimsy partnered with Fetch for consulting and media marketing, including kitchen visits and early conversations about the menu.", "The early story introduced Chef Gretchen, known locally for her work at Atlas, and the combination of fresh foods, local goods, and specialty market finds planned for the space. It gave people something specific to follow as the business took shape."],
    hero: ["1447327190754894", "Fetch Market sign and Chef Gretchen in an early business announcement"],
    services: ["Business consulting", "Launch messaging", "Media marketing"],
    sections: [
