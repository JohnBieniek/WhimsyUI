...
type StorySection = { kicker: string; title: StoryHeading; paragraphs: string[]; images: [string, string][]; enlargeImages?: string[]; galleryLayout?: "stacked" | "centered" | "paired" | "aligned"; layout?: "image-left"; card?: "light-purple" | "light-mint"; accent?: "activities" | "shopping" | "event" | "value" };
...
export const archiveStories: Record<string, ArchiveStory> = {
  ...
  "student-art-show": {
    ...
    sections: [
      { kicker: "The 2025 campaign", title: "Help visitors find their way into the show.", paragraphs: ["The 2025 artwork introduced the exhibition, recognized participating schools, and supplied a map of the displays. These pieces answer different questions: why to visit, who is involved, and where to go once you arrive.", "Keeping those jobs distinct lets a visually lively campaign remain useful. A family looking for a school's display needs practical directions as much as an invitation."], images: [["1088502739970676", "School and participant acknowledgments"], ["1088502653304018", "2025 Student Art Show poster"], ["1088502793304004", "Student artwork location map"]], enlargeImages: ["1088502739970676", "1088502793304004"] },
      { kicker: "The 2024 appreciation day", title: "Give the celebration its own supporting cast.", paragraphs: ["The earlier show included a student and teacher appreciation day, with food trucks and music alongside artwork from more than 25 local schools. Whimsy created focused promotions for Petey's Donuts, F'ing Fantastic Food Truck, and the Two Soups duo.", "The archive also records this campaign artwork appearing during JTV's art show interview. Together, the pieces show how a main event can extend into partner promotions and local media coverage."], images: [["822363509917935", "Petey's Donuts promotion for the 2024 appreciation day"], ["822363589917927", "Two Soups live music promotion for the 2024 art show"], ["822363549917931", "Food truck promotion for the 2024 appreciation day"]] },
    ],
  },
  "fetch-market-launch": {
  ...
  "serenity-support": {
    ...
    sections: [
      { kicker: "Consulting and strategy", galleryLayout: "aligned", title: ["Connect the mission to", "a plan the team can use."], paragraphs: ["The sessions considered how fundraising, advertising, and community presence support one another. Discussing local resources and possible collaborations helped put those ideas in the context of the organization's day-to-day work.", "The consultation and training gave the team space to discuss those opportunities together. Each topic returned to the same practical question: how to put the ideas into action in a way that supports the organization's work."], images: [["1437973855023561", "Serenity Sober Living House during the consulting visit"], ["1416300217190925", "Kay and Nicole during an early Serenity consulting visit"]] },
      { kicker: "Community Impact Day", galleryLayout: "aligned", title: "Support also means showing up to help.", paragraphs: ["Whimsy joined the Chamber's Community Impact Day at Serenity, with Jim Hartnett from Harvest Solar lending a hand. The work included weeding, planting flowers, edging, building a fire pit, and clearing a patio.", "The photographs document the volunteers and outdoor work around the house. This was a separate, practical contribution alongside the consulting relationship, supporting the people caring for the home and its grounds."], images: [["1407931354694478", "Volunteers planting and tending the front garden"], ["1407931898027757", "A volunteer in a red plaid vest helping with the grounds during Community Impact Day"], ["1407931418027805", "Kay and a fellow volunteer at the project"]] },
    ],
  },
