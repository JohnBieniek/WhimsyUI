...
import DawnProject from "../dawn-project";
...
export default async function CaseStudy({ params }: { params: Promise<{ slug: string }> }) {
  ...
  if (slug === "dawn-parker-campaign" && archiveStory) return <DawnProject story={archiveStory} title={study.title} />;
    ...
    {isLakeland ? <section className="lakeland-project-sections">
      ...
      <div className="holiday-thanks">
        ...
        <div>
          ...
          <p className="holiday-thanks-cta"><strong>Talk to Whimsy</strong> about planning and advertising a similarly connected campaign for your company, venue, or community event today!</p>
        </div>
      </div>
      ...
      <div className="team-hope-opening">
        ...
        <div>
          ...
          <h2 className="team-hope-two-line-title"><span>One visual style carried</span><span>the invitation and the cause.</span></h2>
          ...
          <p>The work brought HDSA, Jackson Crossing, Neurocrine Biosciences, Teva, and Whimsy into one recognizable visual style. This made the walk details clear while keeping Huntington’s disease awareness as the focus.</p>
      ...
      <aside className="team-hope-close"><p className="kicker">The documented connection</p><h2>Built to support awareness</h2><p>The archived campaign connects the public invitation, HDSA resources, donation messaging, and educational content to one community walk. It reflects HDSA’s commitment to giving families clear, compassionate information and meaningful ways to take action. Whimsy can bring the same connected strategy, design, and storytelling to your organization, helping your mission reach more people and turn awareness into participation.</p></aside>
