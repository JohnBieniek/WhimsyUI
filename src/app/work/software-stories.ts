  ...
  "multiverse-adventurers-guild": {
    ...
    chapters: [
      ...
      },
      {
        ...
        paragraphs: [
          "Rules, Players, and Game Masters each have a dedicated guide. Stable section links let a character-sheet label lead directly to the rule behind a skill, item, weapon, or talent. That makes the publication useful in the middle of a game, when a player needs a specific answer quickly.",
