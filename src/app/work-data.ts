...
const projects: Record<Category, Array<[string,string,string,string,string]>> = {
  ...
  "Brand support": [
    ...
    ["alpha-koney-story","944490221038596.jpg","Alpha Koney Islands Story","Alpha Koney Island","Brand storytelling positioning a familiar mall restaurant as a welcoming place for group gatherings."],
...
export const caseStudies = (Object.entries(projects) as Array<[Category, typeof projects[Category]]>).flatMap(([category,items]) => items.map(([slug,file,title,client,summary]) => ({
  ...
  images:slug==="lakeland-cabaret"?["lakeland cabaret/LAKELAND CABARET clean.png","lakeland cabaret/performer.webp","lakeland cabaret/mall christmas close.jpg","lakeland cabaret/mcordy wand.jpg"]:[file,file],
})));
