...
export default async function ServiceDetail({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <main data-service={slug} className={`article-page${isLakeland ? " single-page-service" : ""}${isMultiverse ? " multiverse-service" : ""}${slug === "website-support" ? " website-support-service" : ""}`}>
    ...
    </section>}{slug === "brand-advertising-plan" && <BrandAdvertisingDetails />}{isLakeland && <section className="featured-site">
    ...
    </section>}{(isLakeland || isMultiverse || slug === "website-transfer") && <PagesCmsCard />}{slug === "website-transfer" && <WebsiteTransferCosts />}{isMultiverse ? <section className="website-deliverables" aria-labelledby="website-deliverables-title">
