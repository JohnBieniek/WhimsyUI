...
export default async function ServiceDetail({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <main className={`article-page${isLakeland ? " single-page-service" : ""}`}>
    <header className="article-hero shell">
      ...
      <div className="article-image"><Image src={service.image} alt={isLakeland ? "Lakeland Cabaret website homepage" : "Whimsy campaign work"} fill priority sizes="(max-width: 700px) 100vw, 45vw"/></div>
    </header>
    {isLakeland && <section className="featured-site shell">
